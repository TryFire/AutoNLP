...
def sep_cnn_model(input_shape,
    ...
    model.add(Embedding(input_dim=num_features, output_dim=100, input_length=input_shape))
...
class Model(object):
    ...
    def train(self, train_dataset, remaining_time_budget=None):
        ...
        # initialize model
        self.model = sep_cnn_model(input_shape=x_train.shape[1:][0],
        ...
        self.model.save(self.train_output_path + 'model.h5')
    ...
    def test(self, x_test, remaining_time_budget=None):
        ...
        if self.model is None:
            self.model = models.load_model(self.test_input_path + 'model.h5')
